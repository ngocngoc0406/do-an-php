...
<?php if(isset($_GET)){
   ...
   $product=mysqli_query($connect,"SELECT * FROM product_menu p LEFT JOIN category_menu c ON p.categoryID = c.categoryID WHERE productName like '%".$tukhoa."%' OR categoryName like '%".$tukhoa."%';");


?>
<section class="search-form">
   <form action="" method="GET">
      <input type="text" class="box" name="timkiem" placeholder="Tìm kiếm..." maxlength="100" 
      value="<?php if(!empty($tukhoa))
      {
         echo $tukhoa;
      } else echo "" ?>">
...
<?php 
   while($row=mysqli_fetch_array($product)){
      // var_dump($row['image']);exit;
?>
   
      <form accept="" method="get" class="box">
